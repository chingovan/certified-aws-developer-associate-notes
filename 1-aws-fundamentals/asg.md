...
## Notes
- ASGs CAN NOT span across Regions.
- ASG can contain EC2 instances in one or more Availability Zones within the same Region
- ASG in VPC contains the instances in same subnet